  ...
  return (
    <div className="min-h-screen bg-white">
      <Head>
        ...
        <link rel="canonical" href="https://www.peter-stoyanov.com/" />
      </Head>
      ...
      <main>
        ...
        <section className="hero-critical">
          {/* Optimized Hero Image with WebP support and proper dimensions */}
          <picture>
            <source 
              srcSet="/pictures/hero-bg.webp" 
              type="image/webp"
              media="(min-width: 768px)"
            />
            <img 
              src="/pictures/hero-bg.png"
              alt="Петър Стоянов - Тренинг за сценично присъствие" 
              className="hero-bg"
              width="1920"
              height="1080"
              priority
              ...
              <div className="hero-content">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                  <Link 
                    ...
                    aria-label="Направи промяната - Присъедини се към листата за изчакване"
                  >
                  ...
                  <Link 
                    href="/about" 
                    className="group inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-white/10 backdrop-blur-sm border-2 border-white/20 rounded-xl shadow-xl hover:bg-white/20 transform hover:scale-105 hover:-translate-y-1 transition-all duration-300"
                    aria-label="Запознай се с Петър - Научи повече за треньора"
                  >
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="relative w-full h-0 pb-[56.25%] rounded-2xl overflow-hidden shadow-2xl mb-12">
                  <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-indigo-600 to-purple-700 flex items-center justify-center">
                    <div className="text-center text-white">
                      <svg className="w-24 h-24 mx-auto mb-4 opacity-80" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="text-center group">
                  <div className="w-24 h-24 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-all duration-300 shadow-2xl border-2 border-white/30">
                    <svg className="w-12 h-12 text-white group-hover:text-yellow-300 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="text-center group">
                  <div className="w-24 h-24 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-all duration-300 shadow-2xl border-2 border-white/30">
                    <svg className="w-12 h-12 text-white group-hover:text-cyan-300 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="text-center group">
                  <div className="w-24 h-24 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-all duration-300 shadow-2xl border-2 border-white/30">
                    <svg className="w-12 h-12 text-white group-hover:text-orange-300 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="relative max-w-6xl mx-auto">
                          ...
                          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex text-yellow-500 justify-center md:justify-start">
                                {[...Array(5)].map((_, i) => (
                                  <svg key={i} className="w-7 h-7 drop-shadow-sm" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
              ...
              <div className="text-center mt-6">
                <button
                  ...
                  aria-label={isAutoPlaying ? 'Спри автоматичното възпроизвеждане' : 'Продължи автоматичното възпроизвеждане'}
                >
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-7xl mx-auto">
                    ...
                    <div className="w-80 h-96 rounded-3xl overflow-hidden shadow-2xl border-4 border-white/20 backdrop-blur-sm bg-white/10 p-2 transform group-hover:scale-105 transition-all duration-500">
                      <div className="w-full h-full rounded-2xl overflow-hidden">
                        <img 
                          ...
                          alt="Преди - Тревожност и страх от комуникация"
                    ...
                    <div className="w-80 h-96 rounded-3xl overflow-hidden shadow-2xl border-4 border-white/20 backdrop-blur-sm bg-white/10 p-2 transform group-hover:scale-105 transition-all duration-500">
                      <div className="w-full h-full rounded-2xl overflow-hidden">
                        <img 
                          ...
                          alt="След - Уверена комуникация и присъствие"
              ...
              <div className="text-center mt-20">
                ...
                <Link 
                  href="/waitlist" 
                  className="group inline-flex items-center justify-center px-10 py-5 text-xl font-black text-cyan-800 bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl hover:shadow-3xl hover:bg-white transform hover:-translate-y-3 hover:scale-105 transition-all duration-300"
                  aria-label="Започни трансформацията си сега"
                >
                    ...
                    <ul className="space-y-3 text-gray-700 mb-8">
                      {t('home.leadMagnetSection.benefits', { returnObjects: true }).map((benefit, index) => (
                        <li key={index} className="flex items-start">
                          <svg className="w-5 h-5 text-indigo-600 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <div className="text-center lg:text-left">
                    ...
                    <form onSubmit={handleLeadMagnetSubmit} className="space-y-4">
                      ...
                      <label htmlFor="email" className="sr-only">
                        Имейл адрес за изтегляне на гида
                      </label>
                      <input
                        id="email"
                        type="email"
                      ...
                      <button 
                        ...
                        aria-label="Изтегли безплатния гид за театрални техники"
                      >
                        {isSubmitting ? (
                          <>
        ...
        <section className="py-20 md:py-28 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center max-w-2xl mx-auto">
              <Link 
                href="/waitlist" 
                className="group inline-flex items-center justify-center px-8 py-4 text-lg font-black text-purple-700 bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl hover:shadow-3xl hover:bg-white transform hover:-translate-y-2 hover:scale-105 transition-all duration-300"
                aria-label="Присъедини се към листата за изчакване за индивидуално обучение"
              >
              ...
              <Link 
                href="/corporate" 
                className="group inline-flex items-center justify-center px-8 py-4 text-lg font-black text-white border-3 border-white/80 rounded-2xl backdrop-blur-sm hover:bg-white/20 hover:border-white transform hover:-translate-y-2 hover:scale-105 transition-all duration-300 shadow-xl"
                aria-label="Научи повече за корпоративно обучение за твоя екип"
              >
