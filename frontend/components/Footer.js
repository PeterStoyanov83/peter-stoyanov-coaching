        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-1 text-center md:text-left">
            ...
            <div className="grid grid-cols-2 gap-3 justify-items-center md:justify-items-start">
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="flex items-center group">
              ...
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="flex items-center group">
