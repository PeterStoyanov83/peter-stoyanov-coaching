      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/corporate" className="text-gray-400 hover:text-white transition duration-300">
                  {t('nav.corporate')}
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/waitlist" className="text-gray-400 hover:text-white transition duration-300">
                  {t('nav.waitlist')}
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <a href="mailto:contact@petarstoyanov.com" className="text-gray-400 hover:text-white transition duration-300">
                  contact@petarstoyanov.com
                </a>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-indigo-400 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col-span-1">
            ...
            <Link href="/waitlist" className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-4 rounded-lg transition duration-300">
              {t('footer.subscribe')}
            </Link>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {currentYear} Petar Stoyanov. {t('footer.allRightsReserved')}
          </p>
          ...
          <div className="mt-4 md:mt-0 flex space-x-6">
            ...
            <Link href="/terms-of-service" className="text-gray-400 hover:text-white text-sm transition duration-300">
